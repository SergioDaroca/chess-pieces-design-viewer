...
2. Refresh the list and cache it after uploading new sets
...
##  Project wishlist: 
An upload button, a rewrite all button, customizable/choosable board colors, download button, favorite saving, game embedding functionality as in ShareChess... none of them happening soon! But be my guest!
